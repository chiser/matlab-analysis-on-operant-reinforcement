...
% flyTracks.centroid = data.centroid(:,:,yokedornot:2:end);
% flyTracks.rightTurns = data.rightTurns(:,yokedornot:2:end);
% flyTracks.currentarm = data.currentarm(:,yokedornot:2:end);
% flyTracks.numTurns = data.numTurns(:,yokedornot:2:end);
% flyTracks.tSeq = data.tSeq(:,yokedornot:2:end);
% flyTracks.rBias = data.rBias(:,yokedornot:2:end);
% yokedornot=2;
% flyTracks.centroid = data.centroid(:,:,yokedornot:2:end);
% flyTracks.rightTurns = data.rightTurns(:,yokedornot:2:end);
% flyTracks.currentarm = data.currentarm(:,yokedornot:2:end);
...
% plot(cat(2,left_entries',middle_entries',right_entries')','o')
% boxplot(cat(2,left_entries',middle_entries',right_entries'),'labels',{'Left','Middle','Right'},'Colorgrad','blue_down',...
