...
%% Kinda Markov model. I would need to do it to individual flies though
choice_after1=histcounts(arm(find(arm==1)+1),2);
choice_after2=histcounts(arm(find(arm==2)+1),2);
choice_after3=histcounts(arm(find(arm==3)+1),2);
